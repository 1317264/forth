...
public class MovieCrawler {
    public static void main(String[] args) {
        ...
        for(i=start;i<=end;i++){
            String url="https://movie.douban.com/subject/"+String.valueOf(i)+"/";
            try{
                HttpsUrlValidator.retrieveResponseFromServer(url);//忽略证书
                ...
                elements=doc.getElementsByClass("rating_sum");
                if(!elements.first().text().equals("暂无评分")){
                    ...
                    elements=doc.getElementsByClass("rating_per");
                ...
                for(Element element:elements){
                    ...
                    if(elements1.text().equals("导演")){
                        ...
                        for(j=0;j<elements2.size();j++) {
                            ...
                            sql = "insert into director values(" + String.valueOf(i) + "," + String.valueOf(j + 1) + ",'" + director + "')";
                            mysql.Save(sql);
                        }
                    }
                        ...
                        for(j=0;j<elements2.size();j++) {
                            ...
                            sql = "insert into screenwriter values(" + String.valueOf(i) + "," + String.valueOf(j + 1) + ",'" + screenwriter + "')";
                            mysql.Save(sql);
                        }
                    }
                        ...
                        for(j=0;j<elements2.size();j++) {
                            ...
                            sql = "insert into actor values(" + String.valueOf(i) + "," + String.valueOf(j + 1) + ",'" + actor + "')";
                            mysql.Save(sql);
                        }
                    }
                }
